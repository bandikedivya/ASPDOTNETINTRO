...
namespace Introduction.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        //https://localhost:7287/api/Login/LoginUser
        [HttpPost("LoginUser")]
        public IActionResult LoginUser([FromBody] CustomerDTO customerDTO)
        {
            ...
            {
                return BadRequest("Kindly don't give your values either null or empty. Please give the username and password correctly");
            }
            else
            {
